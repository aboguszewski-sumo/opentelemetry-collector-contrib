...
| **mysql.index.io_waits** | The total count of I/O waits events for an index. | 1 | Sum(Int) | <ul> <li>io_waits_operations</li> <li>io_waits_name</li> <li>schema</li> <li>io_waits_index</li> </ul> |
| **mysql.index.io_waits.time** | The total time of I/O waits events for an index. | ms | Sum(Int) | <ul> <li>io_waits_operations</li> <li>io_waits_name</li> <li>schema</li> <li>io_waits_index</li> </ul> |
...
| **mysql.table.io_waits** | The total count of I/O waits events for a table. | 1 | Sum(Int) | <ul> <li>io_waits_operations</li> <li>io_waits_name</li> <li>schema</li> </ul> |
| **mysql.table.io_waits.time** | The total time of I/O waits events for a table. | ms | Sum(Int) | <ul> <li>io_waits_operations</li> <li>io_waits_name</li> <li>schema</li> </ul> |
...
| io_waits_index (index) | The name of the index. |  |
| io_waits_name (name) | Table name for event or process. |  |
